    ...
    <div class="container-fluid p-0 overflow-hidden">
        <div class="row g-0 min-vh-100">
            ...
            <div class="col-lg-6 d-none d-lg-flex flex-column justify-content-between p-5 text-white position-relative"
                style="background: linear-gradient(135deg, rgba(79, 70, 229, 0.95), rgba(59, 130, 246, 0.9)), url('https://images.unsplash.com/photo-1614064641938-3bbee52942c7?q=80&w=1632&auto=format&fit=crop') no-repeat center center; background-size: cover;">
                ...
                <div class="my-auto max-w-md animate__animated animate__fadeInLeft">
                    <h1 class="display-5 fw-extrabold mb-3 text-white">Reset Password</h1>
                    <p class="lead text-white-50 mb-4">Create a strong and secure new password to ensure your profile and items remain completely safe.</p>
                </div>
            ...
            <!-- 🔐 ផ្នែកខាងស្តាំ៖ ទម្រង់ Reset Form -->
            <div class="col-12 col-lg-6 d-flex align-items-center justify-content-center bg-white p-4 p-sm-5 position-relative">
                ...
                <div class="login-box-width">
                    ...
                    <div class="mb-4">
                        <h2 class="fw-bold text-dark mb-2">Setup New Password</h2>
                        <p class="text-muted">Please fill in the details below to complete your password reset.</p>
                    </div>
